  ...
  SimpleVertex vertices[] =
      {
          ...
          {XMFLOAT3(1, 0, 0), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(1, 1, 0), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(0, 1, 0), XMFLOAT3(0, 0.5, -1)},

          {XMFLOAT3(0, 0, 1), XMFLOAT3(0, 0, 1)},
          {XMFLOAT3(0, 1, 1), XMFLOAT3(0, 0, 1)},
          {XMFLOAT3(1, 0, 1), XMFLOAT3(0, 0, 1)},

          {XMFLOAT3(1, 0, 1), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(1, 1, 1), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(0, 1, 1), XMFLOAT3(0, 0.5, -1)},
          ...
          {XMFLOAT3(0, 1, 1), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(0, 1, 0), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(0, 0, 0), XMFLOAT3(0, 0.5, -1)},
          ...
          {XMFLOAT3(0, 0, 0), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(0, 0, 1), XMFLOAT3(0, 0.5, -1)},
          {XMFLOAT3(1, 0, 0), XMFLOAT3(0, 0.5, -1)},
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
  ...
  case WM_LBUTTONDOWN: // reakcja na lewy przycisk myszki
  {
    // x = LOWORD(lParam);
    // y = HIWORD(lParam);
    flaga_button_down = true;
    stare_x = LOWORD(lParam);
    break;
  }
  case WM_LBUTTONUP: // reakcja na lewy przycisk myszki
  {
    flaga_button_down = false;
    break;
  }
  case WM_MOUSEMOVE:
    if (flaga_button_down)
    {
      alpha += (LOWORD(lParam) - stare_x) / 2;
      stare_x = LOWORD(lParam);
      if (alpha >= 180)
        alpha = -180;
    }
...
void Render()
{
  ...
  float r = 10;
  float PI = 3.141;
  float x = r * sin(alpha * PI / 180);
  float z = r * cos(alpha * PI / 180);
  XMVECTOR Eye = XMVectorSet(x, 3.0f, z, 0.0f);
  ...
  else
  {
    ...
    if (timeStart == 0)
      timeStart = timeCur;
    t = (timeCur - timeStart) / 3000.0f;
  }

  // Rotate around the origin
  g_World = XMMatrixRotationY(t);
  g_World *= XMMatrixTranslation(1, 0, 0);
